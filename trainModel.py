...
def generateData(batch_size,input_shape):
    ...
    train_generator = train_datagen.flow_from_directory(
            'C:\\Users\\Rotha Uy\\Documents\\firstaid_model\\Dataset\\training',  # this is the target directory
    ...
    validation_generator = test_datagen.flow_from_directory(
            'C:\\Users\\Rotha Uy\\Documents\\firstaid_model\\Dataset\\validating',
    ...
    test_generator = test_datagen.flow_from_directory(
            'C:\\Users\\Rotha Uy\\Documents\\firstaid_model\\Dataset\\testing',
            target_size=input_shape,
            batch_size=batch_size,
            class_mode='categorical',
            shuffle = False,
            save_to_dir = 'C:\\Users\\Rotha Uy\\Documents\\firstaid_model\\Dataset\\generated\\testing',
            save_format = 'png')
...
def main():
    ...
    model.save_weights('findWound_AlexNet_weight.h5')

    # save the model
    model.save('findWound_AlexNet_model.h5')
